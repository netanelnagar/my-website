  ...
  return (
    <>
      ...
      <a
        ...
        aria-label="WhatsApp"
        className="fixed bottom-6 right-6 lg:bottom-12 lg:right-12 z-50 p-3 lg:p-4 rounded-full bg-gradient-to-r from-primary to-secondary text-white shadow-lg hover:scale-105 transition-transform"
      >
